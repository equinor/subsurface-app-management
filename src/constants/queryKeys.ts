...
export const GET_RELEASE_NOTES = 'getReleaseNotes';
export const GET_TUTORIAL_STEP_IMAGE = 'getTutorialStepImage';
export const GET_SURVEY_FOR_APP = 'getSurveyForApp';
